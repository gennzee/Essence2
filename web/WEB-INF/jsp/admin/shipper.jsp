                                                    ...
                                                    <c:forEach var="rows" items="${listShipper}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<s:url value="../admin/delete_shipper/${rows.id}.htm"/>" class="btn btn-danger btn-sm" data-placement="top" data-toggle="tooltip" data-title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                            </td>
                                                            <td>${rows.id}</td>
