                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="card-box noradius noborder bg-danger">
                                    ...
                                    <h6 class="text-white text-uppercase m-b-20">Order Pending</h6>
                                        ...
                                        <div class="widget-messages nicescroll" style="height: 400px;">
                                            <a href="#">
                                                <div class="message-item">
                                                    <div class="message-user-img"><img src="../admin/assets/images/avatars/avatar2.png" class="avatar-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="message-item">
                                                    <div class="message-user-img"><img src="../admin/assets/images/avatars/avatar5.png" class="avatar-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="message-item">
                                                    <div class="message-user-img"><img src="../admin/assets/images/avatars/avatar6.png" class="avatar-circle" alt=""></div>
                                            ...
                                            <a href="#">
                                                <div class="message-item">
                                                    <div class="message-user-img"><img src="../admin/assets/images/avatars/avatar10.png" class="avatar-circle" alt=""></div>
